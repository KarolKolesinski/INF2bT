...
def suma_cyfr(liczba): #liczba jest typu string
    suma = 0
    for cyfra in liczba:
        suma +=int(cyfra)
    return suma

def pierwsza(liczba): #liczba jest typu int
    if liczba < 2:
        return False
    if liczba == 2:
        return True
...
lista_trojek = []
with open("C:/Users/kar.kolesinski/Documents/GitHub/INF2bT/ZbiorCKE/zadanie66/trojki.txt") as plik:
    for linia in plik:
